...
var vg_pagination = (page, total) => {
	...
	let pagination = `
	<section class="mod margin-t-15">
	    <div class="screenList">
	        <div class="box">               
	            <div class="nav-wrap">
	                <div class="wrap">
	                    <ul class="swiper-wrapper clearfix" style="display: flex;justify-content: space-between;">
	                        <li class="swiper-slide active" tapmode onclick="showDefault('loading')"><a href="javascript:goNumPage('pre');">上集</a></li>
	                        <li class="swiper-slide active" tapmode onclick="showDefault('loading')"><a data-p="${pre_page}" href="javascript:;" onclick="vg_pjax($(this));" class="${pre_status}">上页</a></li>
	                        <li class="swiper-slide active" tapmode><a>${page}/${total}</a></li>
	                        
	`;
	pagination += `
		<li class="swiper-slide active" tapmode onclick="showDefault('loading')"><a data-p="${next_page}" href="javascript:;" onclick="vg_pjax($(this));">下页</a></li>
		<li class="swiper-slide active" tapmode onclick="showDefault('loading')"><a data-p="${next_page}" href="javascript:goNumPage('next');">下集</a></li>
 					</ul>
        		</div>
        		</div>
        	</div>
